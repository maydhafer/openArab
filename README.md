...
<p>
<strong>شرح وتعريب بواسطة <a href="https://x.com/alraigah">مي للتقنية</a></strong> — عشان كل عربي يوصل لأقوى أدوات الذكاء الاصطناعي بسهولة
<br>
...
<li>إذا استخدمت مهارة تتطلب خدمة خارجية مدفوعة (مثلاً أدوات تحليل احترافية)</li>
...
يعني:
البرنامج مجاني ✔  
لكن "المفاتيح" والخدمات الخارجية هي اللي عليها تكلفة حسب استخدامك.
